...
for i in range(1,numberThickness+1):
	...
	combinedDel = [fits.Column(name='del{}'.format(k+1),format='150E', unit = 'rad', array = delColumnList[k]) for k in range(numberHeights)]
	combinedDelInc = [fits.Column(name='del_inc{}'.format(k+1),format='150E', unit = 'rad', array = delIncColumnList[k]) for k in range(numberHeights)]
